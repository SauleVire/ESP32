...
| onReboot | Badly named, should be ā€justBeforeRebootā€¯ can be initiated by webUi, MQTT command, physical hardware on GPIO0 | None | On exit from your code, the device will reboot (soft reset) |
| onFactoryReset | Badly named, should be ā€justBeforeFactoryResetā€¯ can be initiated by webUi, MQTT command, physical hardware on GPIO0 | None | On exit from your code, the device will ā€hard resetā€¯ to factory settings, i.e. all configuration data and saved WiFI connections will be lost |
...
| cmd/echo/listen |  |  |  | Discovery or ā€pairingā€¯ mode |
