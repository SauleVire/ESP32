...
<tr><td align="right">SSID:</td><td><input type="text" id="ssid" name="ssid" maxlength="12" value=""></td></tr>
<tr><td align="right">Slaptažodis :</td><td><input type="text" id="password" maxlength="12" name="password" value=""></td></tr>
<tr><td align="right">DHCP :</td><td><input type="checkbox" id="dhcp" name="dhcp"></td></tr>
<tr><td align="right">Tinklo adresas :</td><td>
<input type="text" id="ip_0" name="ip_0" size="1">.
<input type="text" id="ip_1" name="ip_1" size="1">.
<input type="text" id="ip_2" name="ip_2" size="1">.
<input type="text" id="ip_3" name="ip_3" size="1"></td></tr>
<tr><td align="right">DNS adresas :</td><td>
<input type="text" id="dns_0" name="dns_0" size="1">.
<input type="text" id="dns_1" name="dns_1" size="1">.
<input type="text" id="dns_2" name="dns_2" size="1">.
<input type="text" id="dns_3" name="dns_3" size="1"></td></tr>
<tr><td align="right">Tinklo kaukė :</td><td>
<input type="text" id="nm_0" name="nm_0" size="1">.
<input type="text" id="nm_1" name="nm_1" size="1">.
<input type="text" id="nm_2" name="nm_2" size="1">.
<input type="text" id="nm_3" name="nm_3" size="1"></td></tr>
<tr><td align="right">Tinklų sietuvas :</td><td>
<input type="text" id="gw_0" name="gw_0" size="1">.
<input type="text" id="gw_1" name="gw_1" size="1">.
<input type="text" id="gw_2" name="gw_2" size="1">.
<input type="text" id="gw_3" name="gw_3" size="1"></td></tr>
<tr><td colspan="2" align="center">
<input type="submit" style="width:150px" class="myButton" value="Įrašyti"></td></tr>
</table>
</form><div align="center"><a href="/"   style="width:220px"  class="myButton" >Pradžia</a></div>
</center>
