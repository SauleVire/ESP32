...
void Akumuliacine_talpa () {
 ...
 if ((Katilas >= config.At_ON_T) && (config.At_Siurblio_busena == false))  {
   digitalWrite(HeatTanktRELAYPIN, LOW); // Įjungiamas akumuliacinės talpos siurblys
...
Serial.println("Akumuliacines talpos siublys IJUNGTAS *** ON ***");
              ...
              digitalWrite(HeatTanktRELAYPIN, HIGH); // Išjungiamas akumuliacinės talpos siurblys
