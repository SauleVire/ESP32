...
<div><span id="pv_palaikoma_t"></span>&deg; C</div>
<div><span id="pv_tolerancijos_t"></span>&deg; C</div>
<div><span id="pv_on_t"></span>&deg; C</div>
<div><span id="pv_off_t"></span>&deg; C</div>
...
{        
  ...
  values += "pv_palaikoma_t|" + (String)config.PV_palaikoma_T +  "|div\n";
  values += "pv_tolerancijos_t|" + (String)config.PV_tolerancijos_T +  "|div\n";
  values += "pv_on_t|" + (String)config.PV_ON_T +  "|div\n";
  values += "pv_off_t|" + (String)config.PV_OFF_T +  "|div\n";
