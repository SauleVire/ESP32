...
<a href="update" class="myButton" >></a>

<hr>
<form action="" method="get">
<table border="0"  cellspacing="0" cellpadding="3" >
<tr><td align="right">NTP Serveris :</td><td><input type="text" id="ntpserver" name="ntpserver" maxlength="172" value="" ></td></tr>
<tr><td align="right">Naujinti (min):</td><td><input type="text" id="update" name="update" size="3"maxlength="6" value="" size="1"> (0=neleisti)</td></tr>
<tr><td align="right">Laiko juosta :</td><td>
